...
In **polyrepo layout** (sometimes also called **multirepo layout** ), on the other hand, the code is spread across... well multiple repositories. The degree to which the separation between logical pieces of code can vary from language to language and from style to style. <sup class="footnote-ref"><a href="#fn1" id="fnref1">[1]</a></sup>
...
### Imports
<!-- ![Containers seen from above](https://blog.earthly.dev/content/images/2021/01/chuttersnap-kyCNGGKCvyw-unsplash.jpg) --> ![Shipping containers seen from above](/content/images/2021/01/chuttersnap-kyCNGGKCvyw-unsplash.jpg)
...
<!-- ![Software engineers collaborating](https://blog.earthly.dev/content/images/2021/01/cowomen-cKQkMFzXHAI-unsplash.jpg) --> ![Software engineers collaborating](/content/images/2021/01/cowomen-cKQkMFzXHAI-unsplash.jpg)
...
### Releases
<!-- ![vidar-nordli-mathisen-y8TMoCzw87E-unsplash](https://blog.earthly.dev/content/images/2021/01/vidar-nordli-mathisen-y8TMoCzw87E-unsplash.jpg) --> ![A loaded cargo ship](/content/images/2021/01/vidar-nordli-mathisen-y8TMoCzw87E-unsplash.jpg)
...
### Builds and CI
<!-- ![Cranes above a construction project](https://blog.earthly.dev/content/images/2021/01/danist-8Gg2Ne_uTcM-unsplash.jpg) --> ![Cranes above a construction project](/content/images/2021/01/danist-8Gg2Ne_uTcM-unsplash.jpg)
...
[![Any organization that designs a system (defined broadly) will produce a design whose structure is a copy of the organization's communication structure. — Melvin E. Conway](/content/images/2021/01/conway-quote.png)](https://en.wikipedia.org/wiki/Conway%27s_law)
...
### Issue tracking
<!-- ![Engineer placing sticky notes on the wall](https://blog.earthly.dev/content/images/2021/01/you-x-ventures-Oalh2MojUuk-unsplash.jpg) --> ![Engineer placing sticky notes on the wall](/content/images/2021/01/you-x-ventures-Oalh2MojUuk-unsplash.jpg)
...
### Open-source
<!-- ![Open hands arranged in a circle](https://blog.earthly.dev/content/images/2021/01/sharon-mccutcheon-fkFNBCQ6kQA-unsplash.jpg) --> ![Open hands arranged in a circle](/content/images/2021/01/sharon-mccutcheon-fkFNBCQ6kQA-unsplash.jpg)
...
<p>In some extreme cases, the segmentation can be so aggressive, that you end up with microrepos: repositories that perform specific functions. See for example this <a href="https://github.com/parro-it/awesome-micro-npm-packages">collection of micro NPM packages</a>. There's a package for checking if an array is sorted?? Huh... <a href="#fnref1" class="footnote-backref">↩︎</a></p>
</li>
<li id="fn2" class="footnote-item">
<p>Care must be taken, however, as even though a PR is merged as a single atomic change, the way this lands in production is never atomic. Certain considerations still apply as usual. <a href="#fnref2" class="footnote-backref">↩︎</a></p>
</li>
</ol>
