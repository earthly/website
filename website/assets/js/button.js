...
(function () {
    ...
    var render = function (root, options, func) {
      ...
      var btn = createElement('a', {
        ...
        innerHTML: octicon(options['data-icon'], isLarge ? 22 : 14)
      }, [
        ' ',
