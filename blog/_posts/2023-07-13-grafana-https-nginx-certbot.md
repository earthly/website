...
![An Http image](https://i.imgur.com/TrNLHGf.png) 
...
Note: If you are using a different Linux distribution other than Ubuntu, Click [here](https://nginx.org/en/linux_packages.html)  to access the appropriate commands for your Linux distribution.
...
![A screenshot of an AWS Ubuntu server](https://i.imgur.com/FJF1WHN.png)

If such prompts appear, press `ENTER` to allow the default option, which will restart all the services listed in the prompt. 

![An output screenshot after pressing `enter`](https://i.imgur.com/xkypavb.png)
...
![A screenshot of the Nginx service status](https://i.imgur.com/Cd3nakr.png) 
...
![A screenshot of the Nginx welcome page](https://i.imgur.com/nP6QGMF.png) 
...
Not using Ubuntu Linux? Please check [here](https://grafana.com/docs/grafana/latest/setup-grafana/installation/) for installation commands appropriate for your OS distribution.
...
![Screenshot of an active Grafana server](https://imgur.com/s4jw8iV.png)
...
![An output of the systemctl autostart command](https://i.imgur.com/xwNXeQg.png)
...
![A screenshot of my domain routing to Grafana via Http](https://i.imgur.com/RXkmEwH.png) 
...
![A screenshot of certbot successfully installed](https://i.imgur.com/WRA0hSo.png)
...
![Deploying SSL Certificate](https://i.imgur.com/OMPOKXZ.png)
![Deploying SSL Certificate](https://i.imgur.com/2DakRiS.png) 
...
![Screenshot of a secured Grafana website](https://i.imgur.com/BUb7VJr.png) 
