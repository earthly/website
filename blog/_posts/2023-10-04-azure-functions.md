...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We streamline software builds using containerization. If you're into Azure Functions, you'll appreciate how Earthly can optimize your CI build process. [Check it out](/).**
