...
![Deepnote sign up page]([https://imgur.com/z025oRv.png](https://imgur.com/z025oRv.png))
...
![Deepnote Onboarding page]([https://imgur.com/tadKsId.png](https://imgur.com/tadKsId.png))

Finally, give your workspace a name and click “Next” to access it and see a screen like the one below.

![Deepnote workspace](https://imgur.com/iyJQA6C.png)
...
![Deepnote new project](https://imgur.com/CTJ8sDq.png)
...
You will be building the admin panel of this system. The building, in this case, is the [Umbrella Academy](https://www.imdb.com/title/tt1312171/). The initially authorised individuals are any of the Hagreeves and their robot mother. The images used were gotten from the [Umbrella Academy Wiki](https://umbrellaacademy.fandom.com/) and can be downloaded from the [umbrella](https://github.com/Fortune-Adekogbe/Facial-Recognition-System/tree/main/Deepnote/umbrella) and [test](https://github.com/Fortune-Adekogbe/Facial-Recognition-System/tree/main/Deepnote/test) folders.
...
![Deepnote images uploaded](https://imgur.com/TczQpPJ.png)
...
![output from checking test images](https://imgur.com/yrXzu4I.png)
...
![Anvil dashboard](https://imgur.com/cGHHYfX.png)
...
![Anvil app default view](https://imgur.com/9Cqx0WX.png)
...
![Anvil entry point form](https://imgur.com/mTYpFfV.png)
...
![Anvil CheckForm](https://imgur.com/UKacj1U.png)
...
![Anvil add form](https://imgur.com/Z1bnWFG.png)
...
![Anvil remove form](https://imgur.com/lVrxmKa.png)
...
![anvil-get-uplink-key](https://imgur.com/50KymOD.png)
...
![Anvil app test screenshot](https://imgur.com/GyueBhL.png)
