...
![Kubernetes deployments diagram](https://i.imgur.com/ptpr1xB.png)
...
![Pre-flight check](https://i.imgur.com/dD0bZEn.png)
...
```bash
$ kubectl create ingress test-localhost --class=nginx --rule="test.localdev.me/*=demo-app:80"
```
...
![TLS connection diagram](https://i.imgur.com/mTZ9rWM.png)
...
![TLS handshake](https://i.imgur.com/Xj3eaz8.png)
...
![Mutual TLS connection diagram](https://i.imgur.com/7FExOTX.png)
...
![400 Error](https://i.imgur.com/iPruOBz.png)
...
![Mutual TLS Handshake](https://i.imgur.com/E9FDfel.png)
