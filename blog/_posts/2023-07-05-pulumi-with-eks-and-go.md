...
![Viewing permissions policy for IAM user](https://i.imgur.com/3461gRI.png)
...
![Installing pulumi](https://i.imgur.com/mNmvI1Q.png)
...
![Inputting access token for pulumi](https://i.imgur.com/nhBli0o.png)
...
![Selecting platform and programming language (aws-go)](https://i.imgur.com/oOSImPM.png)
...
![Inputting template, project name, project description, stack name, and aws region](https://i.imgur.com/GdVSZJd.png)

Once Pulumi has installed the dependencies, you should have the following output:

![Verifying pulumi dependency installation](https://i.imgur.com/INzm0eY.png)
...
![Viewing files created by pulumi](https://i.imgur.com/5SEGnDY.png)
...
![Downloading plugins needed to create S3 bucket on AWS](https://i.imgur.com/T2rwXE4.png)
...
![Viewing proposed updates to be made by pulumi](https://i.imgur.com/DP7XxSm.png)
...
![Viewing pulumi confirmation question](https://i.imgur.com/ntLHpph.png)

Once selected, Pulumi will create an S3 bucket on your AWS account:

![Viewing successful updates and bucket name](https://i.imgur.com/UJLDkSe.png)
...
![Viewing resources created by pulumi](https://i.imgur.com/uvLZvjJ.png)

Now, on your AWS account, you should see your S3 bucket created:

![Viewing S3 bucket on AWS account](Ihttps://i.imgur.com/EKDnwLN.png)
...
![Viewing resources created by pulumi (three S3 buckets)](https://i.imgur.com/tRiAymO.png)
...
![Viewing S3 buckets via the AWS S3 page](https://i.imgur.com/sUbMbMP.png)
...
![Downloading EkS and EC2 SDKs](https://i.imgur.com/lBH0MUd.png)
...
![Viewing EKS kubeconfig, resources created by pulumi and duration](https://i.imgur.com/BRXibeb.png)
...
![Viewing EKS cluster over EKS page](https://i.imgur.com/CQDkyvQ.png)
...
![Viewing outputs (deployment-name and kubeconfig)](https://i.imgur.com/JkE6MIe.png)


![Viewing outputs (namespace-name) and resources created](https://i.imgur.com/MmcrJlG.png)
...
![Viewing cluster nodes, namespace, deployments, and pods](https://i.imgur.com/pFWYWkZ.png)
...
![Deleting the pulumi stack](https://i.imgur.com/BoaVDIv.png)
