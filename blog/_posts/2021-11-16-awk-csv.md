...
If you were to use `head`, `tail`, or `sort` on a CSV file with line breaks in it you won't get the result you expect. Wrap things in `csvquote`, and your delimited line breaks will be treated correctly. )
