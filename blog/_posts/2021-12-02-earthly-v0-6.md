...
author: Vlad
published: true
excerpt: Earthly v0.6 is here! This release brings exciting new features like support for running containers within containers, user-defined commands for standardized builds, shared caching for faster builds, and cross-platform building. If you're interested in build automation and reproducibility, this article is a must-read.
---
