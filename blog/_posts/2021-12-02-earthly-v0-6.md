...
author: Vlad
published: true
excerpt: "Earthly v0.6 is here with exciting new features! From standardized builds to cross-platform compatibility, Earthly helps ensure consistency and repeatability in your CI builds. With user-defined commands and shared caching, this release takes automation to the next level. Don't miss out on the latest advancements in build automation - check out the full release notes and see how Earthly can revolutionize your workflow."
---
