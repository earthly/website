...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about using psycopg2 to connect to PostgreSQL databases in Python. Earthly is a powerful build tool that can be used in conjunction with psycopg2 to automate the build process and ensure consistent and reproducible results. [Check us out](/).**
