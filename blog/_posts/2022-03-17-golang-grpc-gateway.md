...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about creating a gRPC gateway that accepts HTTP requests and proxies them to a gRPC service. Earthly is a powerful build tool that can be used to streamline the build process for projects that involve gRPC and REST services, making it easier to manage and deploy these types of applications. [Check us out](/).**
