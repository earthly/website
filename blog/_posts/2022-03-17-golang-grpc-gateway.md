...
internal-links:
 ...
 - grpc proxy
topic: go
excerpt: In this article, the author explores different ways to implement a gRPC gateway that accepts HTTP requests and proxies them to a gRPC service. They cover three methods: using the grpc-gateway plugin, creating a REST service based on the gRPC implementation, and combining REST and gRPC in a single service. The article also touches on topics like TLS, certificate generation, and HTTP/2.
---
