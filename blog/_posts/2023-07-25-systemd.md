...
So whatever failsafe is in place seems to restart systemd and restore it to a previous saved state, which I guess is indicated by that number 25. I’m going to keep digging, but that’s probably for another blog post.
