...
Tim is a very senior technical lead and he's good at his job. The problem put to him is: how do we make sure this doesn't happen again? We are expecting N more customers that size of customer A, and we can't afford to have learn this lesson one service at a time. We need a better solution than that.

So Tim studies all the existing services and starts mapping out how queuing and work in progress is handled. It turns the answer is: in all of the possible ways. But mainly, its being done using SQS, a database table, or Kafka.
