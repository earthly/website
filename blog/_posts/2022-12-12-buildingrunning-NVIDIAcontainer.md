...
---
**This article explains the NVIDIA Container Runtime. Use Earthly to streamline your build process if you're using NVIDIA GPUs for AI or ML in containers. [Learn how](/).**
