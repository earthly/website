...
internal-links:
 - just an example
excerpt: "Learn how to create Kubernetes clusters locally using Minikube, a free Kubernetes tool developed by Kubernetes. This tutorial covers the installation of Minikube on Windows, creating a cluster, securing the cluster using RBAC, and other essential concepts. Perfect for beginners who want to experiment with Kubernetes without messing with production environments."
---
...
Hopefully you now have a stronger understanding of how to use Minikube to setup and experiment with kubernetes clusters locally.
