...
The new funding will be used to improve and add more enterprise-friendly features to [Earthly CI LINK](Link to other blog post). Earthly CI is a fast, repeatable CI/CD platform that is super simple to use. It gives teams repeatable CI pipelines that you write once and run anywhere; has an automatic and instantly available build cache that makes builds faster; and it's incredibly user-friendly.
