...
---
**The article explains how to create a network in AWS. Earthly streamlines the build process for DevOps engineers working with AWS. [Learn more about Earthly](/).**
