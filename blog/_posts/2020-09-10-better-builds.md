...
topic: earthly
funnel: 3
excerpt: "Learn how to solve the problem of reproducibility in your build process with Earthly, an open-source tool that encapsulates your build steps in a Docker-like syntax. With Earthly, you can run the exact same build process locally and eliminate any issues caused by environmental differences. Find out how to use Earthly for your Scala projects and ensure reproducibility in your CI builds."
---
