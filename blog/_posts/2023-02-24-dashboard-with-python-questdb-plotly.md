...
![Running Docker Compose command](https://i.imgur.com/GJHoYI3.png)
 
![Accessing QuestDB’s web console](https://i.imgur.com/IyA9iv1.png)
...
![Creating QuestDB Table](https://i.imgur.com/CkwHRFz.png)
...
![Accessing Finnhub API key](https://i.imgur.com/few5xJg.png)
...
![Celery starting and updating](https://i.imgur.com/npycsnl.png)
 
![QuestDB table updating records](https://i.imgur.com/vTKNPnr.png)
...
![Accessing the web app dashboard](https://i.imgur.com/3djKrqn.png)
...
![Selecting specific stock symbol](https://i.imgur.com/ZyVMWQw.png)
