...
![packages/utils/build folder](https://i.imgur.com/PMfBUAT.png)
...
![Local package folder](https://i.imgur.com/HWGHwuT.png)

- A link from `node_modules/@<scope_name>/<package-name>` to `./packages/<package-name>`

![Link between node modules folder and package folder](https://i.imgur.com/Ax54p3z.png)
