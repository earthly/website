...
---
**In this article, you'll learn about Python data classes. If you use data classes as a Python developer, Earthly can simplify your build process with its containerized, reproducible builds. [Check it out](/).**
