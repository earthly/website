...
![Diagram of a simple high-level overview of Nix and Docker](https://i.imgur.com/XHx7tUh.png)
...
Now that you have the `Nix` package manager install in your computer, let’s expore what `nix-shell` command is and how we can use it.
...
![Example of how running a nix-shell command looks like](https://i.imgur.com/DRYEeQx.png)
...
![A screenshot of the Vim Editor from Nix-shell environment](https://i.imgur.com/3Ab74HC.png)
