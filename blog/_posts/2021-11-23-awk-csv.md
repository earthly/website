...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about using AWK with CSV files. Earthly is a powerful build tool that can be used in conjunction with AWK and other command-line tools to simplify and streamline your build process. [Check us out](/).**
