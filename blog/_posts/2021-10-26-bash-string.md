...
---
**This article explains bash string manipulation techniques. Earthly containerizes your build and speeds it up. [Check it out](https://cloud.earthly.dev/login).**
