...
First, you creat an AES block using the `NewCipher` method. The `NewCipher` method takes in the keyphrase, which, in this case, you hashed for increased security.
