...
---
**This article explains how to use the `buf` tool. Earthly ensures reproducible builds of your protocol buffers through seamless integration with `buf`. [Check it out](/).**
