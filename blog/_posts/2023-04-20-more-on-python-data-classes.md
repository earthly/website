...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about Python data classes. Earthly is a powerful build tool that can be used to streamline the build process for projects, including Python projects. [Check us out](/).**
