...
---
**In this article, you'll learn about Python data classes. If you're a Python developer aiming to simplify your data handling, Earthly can greatly improve your build process. [Check it out](/).**
