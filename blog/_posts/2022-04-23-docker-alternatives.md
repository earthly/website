...
---
****This article discusses alternatives to Docker. Earthly's containerized builds extend Docker workflows without directly managing Dockerfiles. [Check it out](/).****
