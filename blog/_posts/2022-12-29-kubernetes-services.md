...
If you're looking to further simplify your build processess, you might want to give [Earthly](https://www.earthly.dev/) a try. It's efficient and super easy to use, and could be the next step in optimizing your Kubernetes workflow.
