...
---
**This article discusses the role of Kubernetes services in microservice architecture. Earthly streamlines and speeds up the build processes for services managed by Kubernetes. [Learn more](/).**
