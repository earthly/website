...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about using Kubescape to scan Kubernetes clusters for security vulnerabilities. Earthly is a powerful tool for building and managing containerized applications, making it a valuable addition to the workflow of developers and system administrators working with Kubernetes clusters. [Check us out](/).**
