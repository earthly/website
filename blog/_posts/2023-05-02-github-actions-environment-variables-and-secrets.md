...
![Enabling GitHub Pages access](https://imgur.com/v4XAgCV.png)
...
![GitHub Actions from a GitHub repo](https://imgur.com/SxKVnpm.png)

Next, search for Gatsby and click **Configure** on the workflow meant to package Gatsby sites:

![Configure the Gatsby deploy workflow](https://imgur.com/ATKriD6.png)
...
![Commit the GitHub Actions workflow config](https://imgur.com/6u826yt.png)
...
![Active and running Actions runs](https://imgur.com/55ub3M9.png)
...
![Deployed site](https://imgur.com/zJwL6rt.png)
...
![Updated GitHub Actions workflow](https://imgur.com/GbRd31R.png)
...
![New Actions run](https://imgur.com/5dDXRoI.png)

When you click on it, you'll see more details and find two jobs—build and deploy:

![Actions run details](https://imgur.com/1MzTGPw.png)
...
![Build step's output logs](https://imgur.com/cGtPsVI.png)
...
![Updated `gatsby.yml`](https://imgur.com/2rqgRIG.png)

Commit the file and head over to the run details to view the output of the job:

![Run execution logs](https://imgur.com/CuZA4p5.png)
...
![Variable moved to the workflow scope](https://imgur.com/Af0qnYw.png)
...
![Step added to the deploy job](https://imgur.com/BY6kRZD.png)
...
![`build` job execution logs](https://imgur.com/3fBpips.png)

The `deploy` job can also do this:

![`deploy` job execution logs](https://imgur.com/2ImCNhD.png)
...
![Create a new repo-level environment variable](https://imgur.com/N6vuSa9.png)

Set a name for your secret and paste the Base64 encoded string. Once done, click on the **Add secret** button:

![Add the secret's details](https://imgur.com/OQ77ePq.png)
...
![Certificate print step](https://imgur.com/rCyvGnt.png)

Commit the file and head over to the build execution logs to see this step in action:

![Decoded certificate in execution logs](https://imgur.com/kOBQa4e.png)
