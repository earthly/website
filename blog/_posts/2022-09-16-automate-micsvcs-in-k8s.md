...
---
**Automating Kubernetes microservices is the focus of this article. Streamline your CI/CD pipeline and achieve more reliable deployments with Earthly if you're orchestrating microservices using Kubernetes. [Explore Earthly](/).**
