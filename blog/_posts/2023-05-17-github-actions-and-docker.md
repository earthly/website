...
internal-links:
 ...
 - Build
 - Docker Container
excerpt: "Learn how to automate the process of developing, testing, and deploying Docker containers using GitHub Actions. This tutorial will guide you through creating a workflow, setting up a runner, running GitHub Actions locally, and setting up the build and test stages. Save time and improve the quality of your software with this powerful automation tool."
---
