...
---
**---
This article discusses the benefits of integrating Earthly into CI workflows. Earthly significantly improves caching and parallel builds for developers who use Docker Compose. [Check it out](https://cloud.earthly.dev/login).
---**
