...
internal-links:
 ...
 - Kubernetes
 - Pipelines
excerpt: "Learn how to build applications in Kubernetes using Tekton, an open-source framework that helps optimize your CI/CD practices. This tutorial guides you through creating a customizable CI/CD workflow with Tekton to deploy a sample application to your Kubernetes cluster."
---
