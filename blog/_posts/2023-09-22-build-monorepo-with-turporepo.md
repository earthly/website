...
Turborepo can [schedule tasks parallely](https://turbo.build/repo/docs/core-concepts/monorepos/running-tasks#turborepo-can-multitask), which optimizes the build by making full use of the CPU cores. Lastly, with [pruning](https://turbo.build/repo/docs/reference/command-line-reference/prune), Turborepo can generate a sparse/pruned subset of the monorepo with only what's needed to build a specific target.
...
![Architecture diagram of the monorepo courtesy of Aniket Bhattacharyea](https://i.imgur.com/lA9Y1xn.png)
...
![Creating a Vue app](https://i.imgur.com/X7quTia.png)
...
![Creating the React app](https://i.imgur.com/cglxvrE.png)
...
![The React app in action](https://i.imgur.com/M6fsMgv.png)

Then open [http://localhost:5174](http://localhost:5174) to see the Vue app:

![The Vue app in action](https://i.imgur.com/JyLcQKI.png)
...
![The result of the `build` task](https://i.imgur.com/XyJv714.png)
...
![The `build` task is cached](https://i.imgur.com/oPyFhf3.png)
...
![The `build` graph](https://i.imgur.com/fB1xGP3.png)
