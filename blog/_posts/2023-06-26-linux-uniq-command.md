...
---
**This article explains the uniq command in Linux. Earthly integrates the uniq command to improve command-line efficiency in automated builds. [Check it out](/).**
