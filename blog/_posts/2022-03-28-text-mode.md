...
---
**We're [Earthly](https://earthly.dev/). This article explores a Text-Mode experiment, which transforms web pages into plain text. After reading it, take a look at [Earthly](https://earthly.dev/).**
