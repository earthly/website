...
---
**The article discusses the advantages of Text-Mode browsing. Earthly now allows for the sharing of build logs in plain text to improve terminal-based workflows. [Check it out](/).**
