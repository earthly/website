...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about Docker image optimization strategies. Earthly is a great tool to use in combination with Docker for optimizing and reducing the size of Docker images. [Check us out](/).**
