...
---
**This article introduces the fundamentals of Apache Airflow. Earthly simplifies continuous integration build processes for data pipelines using Apache Airflow. [Check it out](/).**
