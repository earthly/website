...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about automating data pipelines and workflows using Apache Airflow. Earthly is a powerful build tool that can be used to automate and streamline the data pipeline and workflow processes described in the article. [Check us out](/).**
