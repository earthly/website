...
---
**In this article, you'll learn to run PostgreSQL on Docker. If you manage PostgreSQL in Docker, Earthly simplifies and optimizes your database builds. [Learn more](/).**
