...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about building Pong in your terminal using Golang and the tcell package. Earthly is a powerful build tool that can be used to streamline the development and deployment process for projects like building a Pong game in Golang. [Check us out](/).**
