...
If you don't use a tool, you will never master it. So when I have a task that can possibly solved using `jq` for the next little while at least I'll be trying to jq to solve it. Even if its just exploring a JSON document or a REST API response. 
