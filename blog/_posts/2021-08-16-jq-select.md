...
But this still isn't the JSON document I need. To get these values into a proper JSON object I need the object constructor `{ ... }`. The object construction syntax lets you build a JSON object by using `jq` filters for both keys and values:
