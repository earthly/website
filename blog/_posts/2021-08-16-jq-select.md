 ...
 * big : intro makes a promise that article doesn't deliver on
   ...
   * idea: Add follow up learning resources
...
If you don't use a tool, you will never master it. So when I have a task that can possibly solved using `jq` I'll try to use it, just so I can get some reps in.
