...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about API testing using Playwright with Python. Earthly is a powerful build tool that can be used in conjunction with Playwright and Python to automate the build and testing process of your API projects. [Check us out](/).**
