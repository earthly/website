...
internal-links:
 ...
 - Application
 - JavaScript
excerpt: "Learn how to build a Node.js application with Bazel, an open-source build tool that speeds up builds and tests. This tutorial guides you through setting up the Bazel environment, implementing and testing a simple calculator application, and exposing it on a web server. Discover how Bazel can simplify your Node.js development process."
---
