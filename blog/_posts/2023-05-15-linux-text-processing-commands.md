...
internal-links:
 ...
 - CI/CD
 - Docker
excerpt: "Learn how to efficiently manipulate and process text data in Linux with a variety of powerful commands such as sed, grep, awk, tr, wc, cut, sort, tac, bat, fd, uniq, and xargs. These commands will help you search, replace, extract, and manipulate text in your daily workflow, saving you time and effort."
---
