...
internal-links:
 ...
 - Variables
 - Assignment
excerpt: "Learn all about Makefile variables and how to use them to automate complex processes in your code. Find out how to define variables, set their values, and use them in your targets, prerequisites, and recipes."
---
