...
internal-links:
 ...
 - Variables
 - Assignment
excerpt: Learn all about Makefile variables and how to use them to automate complex processes in your code. Find out how to set variables, append to them, and use special variables like automatic and implicit variables.
---
...
Variables in Make are similar to variables in other programming languages. However, certain features and quirks [make](/blog/using-cmake) them powerful and convenient to use, albeit slightly difficult to wrap your head around.
