...
---
**This article explains how to configure a FluxCD pipeline. Use Earthly with Flux for Kubernetes to simplify your build processes in your GitOps workflow. [Learn more](/).**
