...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about building a real-time communication application with Django Channels and the WebSocket Protocol. Earthly is a powerful build tool that can be used in conjunction with Django Channels and the WebSocket Protocol to streamline the development and deployment process of real-time communication applications. [Check us out](/).**
