...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about optimizing Docker images with Docker Slim. Earthly is a powerful build tool that can be used in conjunction with Docker Slim to optimize and streamline the Docker development process. [Check us out](/).**
