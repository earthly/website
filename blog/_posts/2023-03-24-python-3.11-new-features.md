...
categories:
  - Python
---
**The new Python 3.11 update introduces several features. Earthly optimizes the build and test process for all Python versions. [Learn more](https://cloud.earthly.dev/login).**
...
As you explore these new features and continue to build with Python, consider making your builds consistent and efficient with [Earthly](https://cloud.earthly.dev/login). Especially if you're working with Python builds, Earthly could be a game-changer.
