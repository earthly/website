...
---
**This article explains how to handle YAML in Python. Earthly simplifies Python YAML build processes. [Learn more about Earthly](https://cloud.earthly.dev/login).**
