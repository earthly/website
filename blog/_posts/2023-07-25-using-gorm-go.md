...
**Note**: You can find the code snippets used in this tutorial [here](https://github.com/mercybassey/gorm).
...
![Installing postgresql driver for gorm](https://imgur.com/GzT6sfO.png)
...
```
![Verifying the user record in a postgres database](https://imgur.com/7uHtxtu.png)
...
![Viewing a record (*Agnes Doe*)  ](https://imgur.com/U7Jix1x.png)  
...
![Viewing record marked as deleted](https://imgur.com/RTIqD2d.png)
...
![Viewing record (*Billy John)*](https://imgur.com/yhu18kH.png)
