...
---
**In this article, you'll learn Bash directory commands. If you like using `pushd` and `popd` in Bash for navigating directories, you'll find that Earthly simplifies your build workflows. [Check it out](/).**
