...
---
**This article explains Bash directory commands. Earthly streamlines build workflows similarly to how Bash's `pushd` and `popd` simplify directory navigation. [Learn more](/).**
