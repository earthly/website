...
internal-links:
 ...
 - Inheritance
 - Abstraction
excerpt: "Learn how to create Abstract Base Classes (ABCs) in Python to enforce the implementation of certain methods and attributes in subclasses. Discover how ABCs promote code reuse, consistency, and modularity, and explore real-world use cases for ABCs, such as creating plugin architectures and ensuring compatibility in large projects."
---
