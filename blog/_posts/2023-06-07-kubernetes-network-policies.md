...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about securing Kubernetes with network policies. Earthly is a powerful build tool that can be used in conjunction with Kubernetes to streamline the build and deployment process. [Check us out](/).**
