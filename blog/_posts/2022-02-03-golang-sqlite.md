...
excerpt: "Learn how to use the `database/sql` package in Golang to work with SQLite databases. This tutorial covers topics such as installing SQLite, creating a database schema, populating the database, and performing CRUD operations. If you're interested in learning how to persist data in a SQL database using Golang, this article is for you."
---
