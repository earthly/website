...
sidebar:
  nav: "thoughts"
excerpt: "Learn why top-down standardization efforts can often lead to failure and how understanding local conditions and embedding with specific teams can lead to better solutions. Discover the pitfalls of trying to make the territory match the map and the importance of embracing the tacit knowledge of those closest to the problem."
---
