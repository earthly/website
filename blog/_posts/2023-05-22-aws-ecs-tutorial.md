...
---
**In this article, you'll learn how to use Amazon ECS. If you manage containers with Docker and Amazon ECS, Earthly can simplify your builds. It offers reproducible and parallel builds. [Check it out](/).**
