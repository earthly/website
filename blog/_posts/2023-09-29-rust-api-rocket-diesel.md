...
---
**In this article, you'll learn how to create a Rust CRUD API. If you love Rust, Earthly can streamline your build process, particularly when using frameworks like Rocket and Diesel. [Check it out](/).**
