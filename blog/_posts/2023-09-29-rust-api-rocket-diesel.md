...
---
**This article explains how to create a Rust CRUD API. Earthly simplifies the Rust build process for frameworks like Rocket and Diesel. Learn more at [Earthly](/).**
