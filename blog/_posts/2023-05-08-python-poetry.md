...
![poetry-init-interactively](https://i.imgur.com/KiiHcOZ.gif)
...
[Python Virtual Environments](https://i.imgur.com/foXhfQK.png) 
...
Your project at this stage will look like [this](https://github.com/ashutoshkrris/weather-update). You can copy the contents of the README file from [here](https://github.com/ashutoshkrris/weather-update/blob/main/README.md). Now that you have created your library, you can publish it online for others to install. Poetry provides an easy and efficient way to publish a package by using the `publish` command. 
...
After publishing the package, you can search for it on PyPI. For example, you can find the `weather-update` library [here](https://pypi.org/project/weather-update/). You can then install it on your system and try using it.
