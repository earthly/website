...
---
**This article explores the capabilities of CMake. Earthly provides containerized build environments that complement CMake's clean separation of source and build directories. [Check it out](/).**
