...
---
**In this article, you'll learn how to set up AWS IAM. For developers who manage AWS resources, Earthly provides a containerized method to streamline your CI builds. [Check it out](/).**
