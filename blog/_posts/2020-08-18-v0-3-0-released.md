...
categories:
  - News
excerpt: Check out the latest release of Earthly (v0.3.0) with exciting new features like an interactive mode debugger and support for Dockerfiles. Plus, enjoy faster builds and improved error display. Upgrade now and discover the power of Earthly!
---
