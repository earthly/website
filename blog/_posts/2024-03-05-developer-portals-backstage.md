...
---
**This article provides a step-by-step process for setting up Backstage. Earthly guarantees reproducible builds for developer portals. [Learn more about Earthly](https://cloud.earthly.dev/login).**
