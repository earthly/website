...
All the code examples for this article can be found [here](https://github.com/theifedayo/earthly.dev/tree/main/01-optimizing-go-k8s).
...
![Image of a docker container.](https://i.imgur.com/2Kf7IWF.png)
...
![Image of Dockerfile and Kubernetes pod lifecycle](https://i.imgur.com/652Ncpc.png)
...
![Image of health check and readiness probe.](https://i.imgur.com/DQx6fZD.png)
...
![A Diagram of Cluster Autoscaler Provisioning New Nodes](https://i.imgur.com/3oQr3Fo.png)
