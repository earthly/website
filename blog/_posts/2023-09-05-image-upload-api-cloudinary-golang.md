...
![Cloudinary dashboard](https://i.imgur.com/zIAQlID.jpg)
...
![Application directory structure](https://i.imgur.com/XKUykML.png)
...
![Start application in terminal](https://i.imgur.com/4gpEhM0.jpg)

We can now run a test request to create a new user. The response should look like the following:

![Request to create user](https://i.imgur.com/4413nzI.jpg)
...
1. Add the request URL. The ID should be 1 if you have just one user in the database.
    ![Enter request URL](https://i.imgur.com/up6UYi1.jpg)
    
2. Select the Body tab and choose **form-data**, 
    
    ![Select form-data as body type](https://i.imgur.com/s4fmwpf.jpg)
    
3. Then in the **key** field, switch its type from **text** to **file**, then select the image you want to upload in **value**.
    
    ![Select file to upload](https://i.imgur.com/S5CDlv6.jpg)
...
![Successful image upload request](https://i.imgur.com/CVbAK65.jpg)
