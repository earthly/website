...
---
**This article explains how Earthly simplifies the Jenkins Pipeline automation process. Earthly streamlines the build process for Jenkins Pipeline users. [Check it out](/).**
