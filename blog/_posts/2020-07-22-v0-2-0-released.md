...
categories:
  - News
as_related: false
excerpt: Check out the latest release of v0.2.0, which brings exciting changes like a global configuration file, GitLab support, and examples in Scala, C++, and .NET. Upgrade now and discover the improved features and fixes in this markdown post.
---
