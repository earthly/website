...
categories:
  - News
as_related: false
excerpt: "Check out the latest release of v0.2.0, featuring global configuration options, GitLab support, and fixes for disk space errors. Upgrade now to explore new examples in Scala, C++, and .NET."
---
