...
---
**This article explains how to create translators. Earthly significantly improves GitHub Actions by ensuring build reproducibility and increasing efficiency. [Learn more about Earthly](https://cloud.earthly.dev/login).**
