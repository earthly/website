...
If you're building things with LLMs, I'd love to hear about any tricks you've learned. Also, if you are using GitHub actions, you should [give Earthly a try](https://github.com/earthly/build-transpose/). Earthly can improve the consistency of your build, so you never get a build failure you can't reproduce locally. It works great with GitHub actions. And want your GitHub Actions to be even faster? [Our satellites can make that happen](https://earthly.dev/pricing).
