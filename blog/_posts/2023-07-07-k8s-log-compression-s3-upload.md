...
![Creating and viewing namespace (*database*)](https://i.imgur.com/gXAz5QU.png)
...
![Creating secret (*postgres-secret*)](https://i.imgur.com/boolvGr.png)
...
![Creating and viewing Statefulset (*postgres*](https://i.imgur.com/1GfxYOA.png)
...
![Creating and viewing Postgres Service ](https://i.imgur.com/PTGyrRH.png)
...
![Initializing Node project and installing Kubernetes client library](https://i.imgur.com/Uvc9C5S.png)
...
![Installing aws SDK for javascript](https://i.imgur.com/KBunk8m.png)
...
![Editing package.json file](https://i.imgur.com/nIPaegf.png)
...
![Building image for NodeJS script](https://i.imgur.com/VPeIr6U.png)
...
![Pushing image for NodeJS script to Dockerhub repository](https://i.imgur.com/LQoZfjO.png)
...
![Creating and viewing cronjob](https://i.imgur.com/OIsSvoT.png)
...
![Viewing successful cronjob](https://i.imgur.com/Qqpy5AI.png)
...
![Viewing compressed logs uploads to aws s3](https://i.imgur.com/hjxJYKC.png)
