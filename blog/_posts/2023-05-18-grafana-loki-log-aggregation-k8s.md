...
![Overview Of Grafana Loki]({{site.images}}{{page.slug}}/pVl3qaE.png)
...
![Loki Architecture]({{site.images}}{{page.slug}}/a/KjAHCNV.png)
...
![Deploying Grafana Loki stacks with Helm]({{site.images}}{{page.slug}}/a/OV41tmU.png)
...
![Deployed Grafana Loki Stacks]({{site.images}}{{page.slug}}/a/E7n9BWp.png)
...
![Port Forward session]({{site.images}}{{page.slug}}/a/ViYxS7c.png)
...
![Grafana Login Page]({{site.images}}{{page.slug}}/a/3o1MSe5.png)

Next use the username `admin` and the `password` is the decoded password you obtained earlier.

![Grafana Home Page]({{site.images}}{{page.slug}}/a/pz68lpy.png)
...
![Grafana Explore Page]({{site.images}}{{page.slug}}/a/GXd3L0O.png)
...
![Navigating Grafana UI]({{site.images}}{{page.slug}}/a/IgPs8JS.png)
...
![Running LogQL Query]({{site.images}}{{page.slug}}/a/D71XKQP.png)

![Result of Query Logs]({{site.images}}{{page.slug}}/a/BFPJv9Z.png)
...
![Running LogQL query]({{site.images}}{{page.slug}}/a/Krzja0n.png)

![Result of the LoQL query]({{site.images}}{{page.slug}}/a/rieUI1n.png)
...
![Running LogQL query]({{site.images}}{{page.slug}}/a/H9Cddy4.png)
