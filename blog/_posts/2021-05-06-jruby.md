...
Which brings me back to my original question: Why is JRuby slow for Jekyll?  Jekyll is not forking processes, so that is not the issue.  Hugo, the static site builder for Go is [signifcantly](https://forestry.io/blog/hugo-and-jekyll-compared/#performance-1) faster than Jekyll so we know that Jekyll is not at the pareto front of effiecency where there is simply no more performance to squeeze. To dig in, lets take a look at a flamegraph of the Jekyll build for this blog using RubySpy:
...
Also a caveat: It is possible I missed something here, I am just a guy on the internet trying to answer the question "Why does JRuby exist if it is actually slower when I use it?". If I missed something, I'd love to hear from you.   
