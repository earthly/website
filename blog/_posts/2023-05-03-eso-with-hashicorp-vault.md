...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about using External Secret Operators (ESOs) with HashiCorp Vault for enhancing the security of a Kubernetes cluster. Earthly is a powerful build tool that can be used in conjunction with Kubernetes and HashiCorp Vault to enhance the security and efficiency of your application deployment process. [Check us out](/).**
