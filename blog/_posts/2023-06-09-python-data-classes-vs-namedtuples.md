...
---
**This article explains Python data structures. Earthly enhances Python data class builds by combining the simplicity of named tuples with greater flexibility. [Check it out](/).**
