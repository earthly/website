...
categories:
  - Tutorials
author: Adam
excerpt: "Learn how to easily set up a Linux virtual machine on your macOS with Lima. With Lima, you can have a Linux environment on your laptop, similar to WSL2, and access all your files and ports. Find out how it works and how to install and configure it for a seamless Linux experience on your macOS."
---
## WSL2 for `macOS`
