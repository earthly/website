...
categories:
  - Tutorials
author: Adam
excerpt: Learn how to set up a Linux virtual machine on your macOS with Lima, a simple and efficient tool powered by QEMU. With Lima, you can have a Linux environment on your laptop, access all your files and ports, and even use it as an alternative to Docker Desktop.
---
## WSL2 for `macOS`
