...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about setting up Linux virtual machines on macOS using Lima. Earthly is a powerful build tool that can be used in conjunction with Lima to streamline the development and deployment process of Linux virtual machines on macOS. [Check us out](/).**
