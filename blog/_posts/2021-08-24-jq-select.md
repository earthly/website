...
## Feedback?
<!--sgpt-->
Always excited to hear your feedback or any personal tips you may have, so feel free to reach me on Twitter. Here's a post of mine discussing the JSON tool jq. 

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">jq is great for pretty-printing JSON but it does so much more...</p>&mdash; Adam Gordon Bell 🤓 (@adamgordonbell) <a href="https://twitter.com/adamgordonbell/status/1430193359012851722?ref_src=twsrc%5Etfw">August 24, 2021</a></blockquote> 

I find using this alias beneficial as it gives me the mental comfort of having a safety net, despite rarely needing to revert changes. 

And if you've just mastered jq and are looking to step up your dev game even further, you might want to check out [Earthly](https://www.earthly.dev/). It's your next level in build automation and could be a game-changer for your workflow.
