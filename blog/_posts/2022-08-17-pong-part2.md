...
---
**We're [Earthly](https://earthly.dev/). We make building software simpler and faster using containerization. Working on a Golang project? Earthly can make your build process much smoother and more efficient, perfect for projects like terminal Pong. [Give it a whirl](/)!**
...
## Conclusion
<!--sgpt-->
This tutorial has set the foundation to further refine our game. Enhancements like increasing the ball size, improving score visibility, and experimenting with colors could improve the aesthetics. For now, we've stuck to the default terminal palette. A fun future challenge could be making this a multiplayer game. But we'll save that for another time. 

As you continue to explore Golang and consider future enhancements, you might want to make your building and testing smoother with [Earthly](https://www.earthly.dev/). It's a tool worth trying to streamline your development process.
