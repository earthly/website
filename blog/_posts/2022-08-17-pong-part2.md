...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about building Pong in your terminal using Golang. Earthly is a powerful build tool that can be used to automate the build process for projects like the one described in this article, making it easier to manage dependencies and build pipelines. [Check us out](/).**
