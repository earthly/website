...
internal-links:
 - just an example
topic: kubernetes
excerpt: "Learn how to use Kubernetes ConfigMaps to store and inject configuration parameters into your pods. This article covers the use cases for ConfigMaps, how to create them, and how to consume them in your pods, whether as environment variables, command line arguments, or mounted volume files."
---
