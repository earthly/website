...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about Terraform variables. Earthly is a powerful tool for building and automating CI/CD pipelines, making it a valuable asset for developers and system administrators working with Terraform and infrastructure-as-code. [Check us out](/).**
