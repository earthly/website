...
![Download Terraform](https://i.imgur.com/JggjP8o.png)
...
![AWS Management Console](https://i.imgur.com/6dCzqJY.png)
...
![Select IAM](https://i.imgur.com/cC1KwJu.png)

Click on **Users** to open the users' console;

![IAM](https://i.imgur.com/Wx55xlR.png)

And  then select **Add users** in the upper right-hand corner:

![**Add users**](https://i.imgur.com/PKCJZxe.png)
...
![Specify user details](https://i.imgur.com/REQA5hl.png)
...
![Set permissions](https://i.imgur.com/qn35bWz.png)
...
![Review and create](https://i.imgur.com/Oxbg3Sd.png)
...
![User successfully created](https://i.imgur.com/bLreYGY.png)
...
![Select **Security credentials**](https://i.imgur.com/obXKNMO.png)

Then scroll down to the **Access keys** section and select **Create access key**:

![**Access keys** section](https://i.imgur.com/P7jkWIe.png)
...
![Retrieve access keys](https://i.imgur.com/TGJ0MHP.png)
...
![Configure your AWS credentials](https://i.imgur.com/K7VSsAj.png)
...
![Current VPCs](https://i.imgur.com/usbmXQF.png)
...
![Select VPCs](https://i.imgur.com/8LD0Gdz.png)

On the VPC console, click on **VPC** and you should see the Demo VPC that was created:

![Demo VPC created](https://i.imgur.com/rN5b6xd.png)
...
![No subnets for the VPC](https://i.imgur.com/UjoXhKh.png)
...
![Subnets created](https://i.imgur.com/jaVQ9hT.png)
...
![Default internet gateway](https://i.imgur.com/cKNbpJe.png)
...
![`demo-vpc-IGW` internet gateway created](https://i.imgur.com/aViZ0wt.png)
...
![Current route tables](https://i.imgur.com/AUvw6AJ.png)
...
![Public route table created](https://i.imgur.com/w9qbUdP.png)
...
![Implicit association with main route table](https://i.imgur.com/dYdLkRU.png)
...
![Public subnets associated with public route table](https://i.imgur.com/4lpNvTu.png)
...
![No Elastic IP addresses](https://i.imgur.com/Pp6ysKJ.png)

And there is no NAT gateway:

![No NAT gateway](https://i.imgur.com/aGtzxGv.png)
...
![Elastic IP created](https://i.imgur.com/cYAJmgP.png)

![NAT gateway created](https://i.imgur.com/Mdwu5Et.png)
...
![`web-sg` and `db-sg` security groups created](https://i.imgur.com/dcsjqJA.png)
...
![Currently no instances](https://i.imgur.com/zc65ph6.png)

You need to apply the configuration to add these two instances:

![Two new instances created](https://i.imgur.com/05t0QLb.png)
...
![Private subnet availability zone updates](https://i.imgur.com/NcOPWMR.png)
