...
internal-links:
 ...
 - yaml lint
 - yaml validate
excerpt: "Learn how to use Cuelang, an extension of YAML, to validate your YAML files and prevent runtime errors. Discover how to define types, add constraints, and import packages to improve the structure and reliability of your configuration files."
---
