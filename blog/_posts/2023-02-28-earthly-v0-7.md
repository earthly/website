...
---
<!--sgpt-->**We're [Earthly](https://earthly.dev/). We make building software simpler and therefore faster using containerization. This article is about the release of Earthly v0.7 and its new features and improvements. Earthly is an open-source build tool for CI/CD processes. [Check us out](/).**
