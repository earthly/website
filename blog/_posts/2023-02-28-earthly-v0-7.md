...
internal-links:
 - just an example
excerpt: "Earthly v0.7 is here! This release brings compatibility with Earthly CI, introduces Podman support, and includes the new `WAIT` command for more flexible push ordering. With Earthly, you can simplify your CI/CD processes and enjoy repeatable builds that work with any language or framework. Don't miss out on the latest features and improvements – read the release notes now!"
---
