...
---
**The article provides a guide on setting up a monorepo with Yarn and Vite. Earthly significantly speeds up build times for complex projects using Vite. [Check it out](https://cloud.earthly.dev/login).**
